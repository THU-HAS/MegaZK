    ...
    for ArithmeticBaseGenerator<F, D>
{
    ...
    fn output_targets(&self) -> Vec<Target> {
        vec![Target::wire(self.row, ArithmeticGate::wire_ith_output(self.i))]
    }

    fn pack_params(&self, u_params: &mut Vec<usize>, f_params: &mut Vec<F>, representative_map: &Vec<usize>, num_wires: usize, degree: usize) {
        u_params.push(self.row * num_wires + ArithmeticGate::wire_ith_multiplicand_0(self.i));
        f_params.push(self.const_0);
        f_params.push(self.const_1);
    }

    fn get_params(&self, representative_map: &Vec<usize>, num_wires: usize, degree: usize) -> Vec<usize> {
        vec![self.const_0.to_canonical_u64() as usize, self.const_1.to_canonical_u64() as usize]
    }
