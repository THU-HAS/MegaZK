    ...
    for SimpleGeneratorAdapter<F, SG, D>
{
    ...
    fn pack_params(
        ...
        self.inner
            .pack_params(u_params, f_params, representative_map, num_wires, degree);
    }
    ...
    fn get_params(
        ...
        self.inner.get_params(representative_map, num_wires, degree)
    }
...
impl<F: RichField + Extendable<D>, const D: usize> SimpleGenerator<F, D> for RandomValueGenerator {
    ...
    fn pack_params(
        ...
        u_params.push(self.target.index(num_wires, degree));
    }
...
impl<F: RichField + Extendable<D>, const D: usize> SimpleGenerator<F, D> for ConstantGenerator<F> {
    ...
    fn pack_params(
        ...
        u_params.push(self.row * num_wires + self.wire_index);
        f_params.push(self.constant);
    }
    ...
    fn get_params(
        ...
        vec![self.constant.to_canonical_u64() as usize]
    }
