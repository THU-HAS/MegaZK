...
```bash
cargo +nightly run --release -- -vvv --input-size 100 --output-size 100
```

This is the smoke workload used by the repository-level regression script.
Larger matrix sizes can be restored later for benchmark runs.
